package tomato.example.com.githubsearchuser;
...
import tomato.example.com.githubsearchuser.controller.DetailActivity;
...
public class ItemAdapter extends RecyclerView.Adapter<ItemAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ItemAdapter.ViewHolder viewHolder, int i){
        ...
        Picasso.with(context).load(items.get(i).getavatarUrl())
